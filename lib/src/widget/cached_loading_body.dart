...
class CachedLoadingBody extends StatefulWidget {
  ...
  /// 监听加载真实数据失败
  /// [isCachedDataLoadedSuccess] 是否加载缓存数据成功
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<int>(
      ...
      builder: (BuildContext context, AsyncSnapshot<int> snapshot) {
        // StreamBuilder这里是有个bug的，当重新加载数据的时候，是不会清空error和stackTrace的，但是它的状态是waiting，所以直接忽略这个bug。
        // print("StreamBuilder:$snapshot hasError:${snapshot.hasError}");
