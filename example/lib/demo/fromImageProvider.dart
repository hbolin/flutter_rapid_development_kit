...
/// https://api.flutter-io.cn/flutter/material/ColorScheme/fromImageProvider.html
...
class _DynamicColorExampleState extends State<DynamicColorExample> {
  ...
  Future<void> _updateImage(ImageProvider provider) async {
    final ColorScheme newColorScheme = await ColorScheme.fromImageProvider(provider: provider, brightness: isLight ? Brightness.light : Brightness.dark);
    if (!mounted) {
      return;
    }
    setState(() {
          ...
          .map(
            (ImageProvider image) => Flexible(
              ...
              child: GestureDetector(
                ...
                child: Card(
                  color: widget.images.indexOf(image) == selectedImage ? colorScheme.primaryContainer : colorScheme.surface,
                  child: Padding(
      ...
      children: <Widget>[
        ...
        ColorGroup(
          children: <ColorChip>[
            ...
            ColorChip(label: 'onSurfaceVariant', color: colorScheme.onSurfaceVariant, onColor: colorScheme.surfaceContainerHighest),
          ],
        ),
        divider,
        ColorGroup(
